...
check(int i,int j)
{
	...
	{
	gotoxy(7,5);
	printf("U are Great U got Good score, If possible Please develop this game");
	gotoxy(24,7);
...
{
	outtextxy(240,240,"YOU HAVE TOUCHED THE BORDER");
	outtextxy(280,280,"GAME OVER");
	outtextxy(240,370,"Better Luck Next Time");
	outtextxy(200,310,"<press ENTER to continue>");
	getchar();
	esc();
}
else if(tuch(i,j))
